...
public:
    /**
     *   Construct a SocketException with an explanatory message.
...
public:
     ...
     *   @exception SocketException thrown if WinSock cleanup fails
     */
    static void cleanUp();
...
public:
     ...
     */
    string getForeignAddress() const;
...
public:
    ...
    /**
     *   Read up to bufferLen bytes of data from this socket.  The given buffer
...
#endif // __PRACTICALSOCKET_INCLUDED__
